...
function generateExpression(map, conditions) {
	if (typeof map === 'string') {
		return 'function () {return require(' + JSON.stringify(map) + ');}';
	}
...
var generateString = module.exports.generateString = function (conditions) {
	...
	code += 'var ndarray = module.exports = require("ndarray");\n\n';
	code += "function lazyLoad(target, properties) {\n\tObject.keys(properties).forEach(function (key) {\n\t\tvar value = properties[key];\n\t\tif (typeof value === 'function') {\n\t\t\tif (Object.defineProperty) {\n\t\t\t\tObject.defineProperty(target, key, {\n\t\t\t\t\tconfigurable: true,\n\t\t\t\t\tenumerable: true,\n\t\t\t\t\tget: function () {\n\t\t\t\t\t\tvar actualValue = value();\n\t\t\t\t\t\tObject.defineProperty(target, key, {\n\t\t\t\t\t\t\tvalue: actualValue,\n\t\t\t\t\t\t\tconfigurable: true,\n\t\t\t\t\t\t\tenumerable: true\n\t\t\t\t\t\t});\n\t\t\t\t\t\treturn actualValue;\n\t\t\t\t\t}\n\t\t\t\t});\n\t\t\t} else {\n\t\t\t\ttarget[key] = value();\n\t\t\t}\n\t\t} else {\n\t\t\ttarget[key] = lazyLoad(target[key] || {}, value);\n\t\t}\n\t});\n\treturn target;\n}\n\n";
	code += "lazyLoad(ndarray, " + expression + ");\n";
	return code;
};
